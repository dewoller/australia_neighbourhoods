max_dist=1
calculate_intermesh_distances <- function( df_mesh_centroids, df_mesh_detail, map_mesh, max_dist=5) {


  # calculate the geohash of each mesh centroid
  df_mesh_centroids %>%
...
# for each mesh block centroid, find all their geohash neighbours
df_gh  %>%
